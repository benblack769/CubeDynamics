...
g++ -O3 -DOPENCL_ACCEL  -o bin/mygl.exe -I"external/glew-1.13.0/include" -I "external/glfw-3.1.2/include" -I "external/glm-0.9.7.1" -I "external/opencl-2.2" main.cpp cube_coords.cpp update.cpp display_ops.cpp triangularize.cpp update_all.cpp opencl_executor.cpp "C:/Windows/System32/OpenCL.dll"  -L./lib64 -lglfw3 -lglew32 -lopengl32 -lgdi32
#
